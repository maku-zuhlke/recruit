  ...
  renderNumberSkeleton(number) {
    ...
    return (
      <div className="number">
        <div className="row horizontalMatchstick">
          <MatchPlaceholder classes="horizontalMatchstickTop" match={matchesObj[1]} pos={[number, 1]} onDrop={this.handleDrop}/>
        ...
        </div><div className="row horizontalMatchstick">
          <MatchPlaceholder classes="horizontalMatchstickMiddle" match={matchesObj[6]} pos={[number, 6]} onDrop={this.handleDrop}/>
        </div><div className="row vertical">
          ...
          <MatchPlaceholder classes="horizontalMatchstickBottom" match={matchesObj[4]} pos={[number, 4]} onDrop={this.handleDrop}/>
        </div>
      </div>
    );
  }
