  ...
  render() {
    return (
      <div className="row center"><ScaleModal ref="modal">
        ...
        <div className="col-xs-12"><a className="btn btn-default talent" href="https://www.zuehlke.com/gb/en/" target="_top">Do you want to become a registered talent of Zühlke</a></div>
      </ScaleModal></div>
    );
  }
}
